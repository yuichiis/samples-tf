...
class Decoder extends AbstractModel
{
        ...
        )
    {
        ...
        $this->repeatVector = $builder->layers()->RepeatVector($targetLength);
        ...
        ) : array
    {
        ...
        $initial_state = $this->repeatVector->forward($initial_state[0],$training);

        $contextVector = $this->attention->forward(
            [$initial_state,$encOutputs],$training,$options);
        ...
        $x = $this->concat->forward([$contextVector, $x],$training);
...
$modelFilePath = __DIR__."/neural-machine-translation-with-attention2.model";
